...
const CourseProgress = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 bg-gradient-to-br from-white to-gray-50 shadow-xl rounded-xl space-y-6">
          ...
          <Card className="overflow-hidden">
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    {isPlaying ? (
                      <span className="flex items-center text-green-600">
                        <CirclePlay className="h-4 w-4 mr-1 animate-pulse" />
                        Currently Playing
                      </span>
            ...
            <CardContent className="p-0">
              {currentSubLecture?.videoUrl ? (
                ...
                <div className="flex flex-col items-center justify-center h-[450px] bg-gray-100 text-gray-400">
          ...
          <Card className="h-full">
            ...
            <CardContent className="p-4 overflow-y-auto max-h-[500px]">
              {lectures?.map((lecture) => (
                ...
                >
                  <CollapsibleTrigger 
                    className={`flex items-center justify-between w-full p-4 transition-colors border rounded-lg ${
                  ...
                  <CollapsibleContent className="bg-gray-50 border border-t-0 rounded-b-lg overflow-hidden">
                    {lecture.subLectures.map((subLecture) => (
                      <div
                        key={subLecture._id}
                        className={`py-3 px-4 transition-colors border-l-4 ${
